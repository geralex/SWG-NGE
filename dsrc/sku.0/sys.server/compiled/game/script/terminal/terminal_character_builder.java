...
public class terminal_character_builder extends script.base_script
{
    ...
    public static final String[] DEV_TESTING_OPTIONS = {
        "Erusman's Dark Jedi Robe ",
        "Portable Bazaar Terminal Schematic",
        "Portable Ship Terminal Schematic",
        "Neural Recon Network Terminal",
        "Respec Reset Device",
        "Resource Supply Generator",
    ...
    public int handleDevTestingOptions(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        {
            case 0:
                static_item.createNewItemFunction("item_jedi_robe_dark_04_06", pInv);
				sendSystemMessageTestingOnly(player, "Erusman's Dark Counselor Robe Issued - New item");
                break;
            case 1:
                static_item.createNewItemFunction("item_schematic_portable_bazaar_terminal", pInv);
                break;
            case 2:
                static_item.createNewItemFunction("item_schematic_portable_space_terminal", pInv);
                break;
            case 3:
                static_item.createNewItemFunction("item_vet_reward_lockout_remover", pInv);
                break;
            case 4:
                static_item.createNewItemFunction("vet_reward_respec_reset", pInv);
                break;
            case 5:
                static_item.createNewItemFunction("vet_reward_resource_crate", pInv);
                break;
            case 6:
    ...
    public int handleWarpOptions(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        {
            case 0:
            warpPlayer(player, "naboo", -3237, 0, 816, null, 0, 0, 0, "", false);
            break;
            case 1:
